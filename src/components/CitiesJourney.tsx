      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <img
            ...
            height={512}
            loading="lazy"
            className="mt-8 w-64 h-auto opacity-80 dark:invert mix-blend-multiply dark:mix-blend-screen md:hidden"
          />
        </div>
        ...
        <div className="hidden md:flex relative items-center justify-center min-h-[520px]">
          <img
            ...
            height={1024}
            loading="lazy"
            className="w-full max-w-xl h-auto opacity-40 dark:invert mix-blend-multiply dark:mix-blend-screen"
          />
        </div>
      </div>
    </motion.div>
